...
<head>
	...
	<script type="text/javascript">
		...
		function setTrueHeight() {
			...
			${if:user}
				someWidth = chatWidth - 28; //-28-120;
			${else:user}
				someWidth = chatWidth - 28; //-28;
			${endif:user}
		...
		function insertonmob(){
			//console.log('insertonmob4444');
			//if(detectmob()){
				//alert('mobile~');
				//window.chatwnd.document.getElementById("content").style.display = "none";
			//}
		}
...
<body class="body">
	...
	<div id="chat">
		<div class="bgl"><div class="bgr"><div class="sdwbgc"><div class="sdwbgl"><div class="sdwbgr">
			<iframe onload="setTrueHeight();" id="chatwnd" name="chatwnd" src="${if:neediframesrc}${mibewroot}/images/blank.html${endif:neediframesrc}" frameborder="0" style="overflow:auto; width:100%;">
	...
	${if:canpost}
		<div class="bgc"><div class="bgl"><div class="bgr">
			<textarea id="msgwnd" class="message" tabindex="0" rows="4" cols="10" onclick="insertonmob()"></textarea>
		</div></div></div>
	${endif:canpost}
	</div>
	<div id="send">
